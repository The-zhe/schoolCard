						...
						>
							...
							<div class="question__actions">
								...
								<div class="flex flex--end">
									...
									<el-button
										class="black-btn other-btn"
										v-show="isShowDown(idx)"
										@click="handleDown(idx)"
										>下移</el-button
									>
...
<script>
	...
	export default {
		...
		computed: {
			...
			isShowUp() {
				return (idx) => {
					return this.questLength > 0 && idx !== 0;
				};
			},
			isShowDown() {
				return (idx) => {
					return this.questLength > 0 && idx !== this.questLength - 1;
				};
			},
		},
		methods: {
