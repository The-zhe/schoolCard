  ...
  >
    <div class="add_question">
      ...
      >
        ...
        <el-table-column label="问题" width="460">
          <template slot-scope="scope">
            <el-collapse style="line-height: 18px">
              <el-collapse-item accordion>
                <template slot="title">
                  <div style="margin-top: 30px;" v-html="scope.row.questionContent"></div>
                </template>
                <div
                  class="option"
                ...
                <div style="margin-top: 30px">
                  答案: <span v-html="scope.row.rightAnswers"></span>
                </div>
              </el-collapse-item>
            </el-collapse>
          </template>
...
export default {
  ...
  methods: {
    ...
    kpsToQuestion(value) {
      console.log('kpsToQuestion',value)
      if(value.length>0){
    ...
    async getQuestion(from) {
      from.grade = this.user.classList[0].grade;
      try {
