<template>
  <el-dialog title="添加题目" :visible.sync="visible" width="50%">
    <el-form :model="dataFrom" ref="dataFrom" :rules="rules" label-width="100px">
      <el-form-item label="选择题型" prop="type">
        ...
        >
          ...
          <el-option label="拍照题" value="5"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="添加数量" prop="num">
        <el-input v-model="dataFrom.num"></el-input>
      </el-form-item>
      <el-form-item label="选项个数" prop="optionNum" v-if="dataFrom.type == '1' || dataFrom.type =='2'">
        <el-input v-model="dataFrom.optionNum"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        optionNum: [{ required: true, message: "请输入选项个数", trigger: "blur" }],
