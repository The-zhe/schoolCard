  ...
  methods: {
    init(item, indexSort) {
      ...
      this.$nextTick(() => {
        ...
        console.log("fileLis11111", this.fileList);
        if (this.fileList.length < 4 || !this.fileList) {
    ...
    toAddCard() {
      ...
      console.log("this.detail.upImgFile", this.detail.upImgFile);
    ...
    success({ data }) {
      ...
      // this.analysisList[1].cont = this.analysisList[1].cont + data.fileName + ",";
      // this.detail.analysisList = this.analysisList;
      console.log("upImgFile", this.detail);
    },
    handleRemove(file) {
